...
void searchListaDoentes(list_doentes_t *list, int val, l_noDoentes_t **prev, l_noDoentes_t **cur); // Função que procura um elemento na lista com base no seu ID
void removeListaDoentes(list_doentes_t *list, int val); // Função que remove um elemento da lista
