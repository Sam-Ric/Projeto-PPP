...
void insertListaRegistos(list_registos_t *list, int id, char data[50], int tensaoMax, int tensaoMin, int peso, int altura); // Função que insere um elemento na lista
void searchListaRegistos(list_registos_t *list, int val, l_noRegistos_t **prev, l_noRegistos_t **cur); // Função que procura um elemento na lista com base no seu ID
